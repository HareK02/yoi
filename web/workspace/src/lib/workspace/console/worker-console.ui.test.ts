...
Deno.test("workspace Tickets surface provides Kanban and lifecycle controls", async () => {
  ...
  assert(
    ticketsLoad.includes("loadLane(fetch, workspaceId") &&
  ...
  assert(
    generatedTicketApi.includes(
      "@generated by yoi-ticket-browser-openapi-typescript@1",
    ) &&
      generatedTicketApi.includes("Input contract: 0.1.0 (sha256:") &&
      generatedTicketApi.includes("export type TicketListResponse") &&
      generatedTicketApi.includes("items: Array<TicketListItemSummary>"),
